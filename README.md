...
**Novi vozači** se kreiraju samo ako su PT employment `ACTIVE`, `is_active=true`
i company driver; **novi kamioni** samo ako su PT-active (`source_is_active`, ne `total loss`)
